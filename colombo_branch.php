...
$branch = "Colombo"; // You can dynamically set this if needed
...
<head>
    ...
    <title>Doctor Details - Colombo Branch- CareCompass Hospitals</title>
    <link rel="stylesheet" href="colombo_branch.css">
</head>
<body>
...
<script>
    function initMap() {
        var hospitalLocation = { lat: 6.89539, lng: 79.85503 }; // Bambalapitiya, Colombo coordinates
