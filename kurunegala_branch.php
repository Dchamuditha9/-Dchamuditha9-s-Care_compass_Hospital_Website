...
$branch = "Kurunegala"; // Changed branch to Kurunegala
...
<head>
    ...
    <title>Doctor Details - Kurunegala Branch - CareCompass Hospitals</title>
    <link rel="stylesheet" href="kurunegala_branch.css">
</head>
<body>
...
<script>
    function initMap() {
        var hospitalLocation = { lat: 7.4821, lng: 80.3677 }; // Kurunegala coordinates
